...
|   newStreamSourceAdded   |    ISourceItem     |                                                                                                              This event is activated whenever a new video source is added to the library (check addSourceItem in the API section).                                                                                                               |             yes             |
