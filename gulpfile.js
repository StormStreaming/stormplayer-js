...
gulp.task('addrequire', function(){
    return gulp.src(['./build/scripts/stormplayer.js'])
...
gulp.task('ts-sourcemaps', function(){
    return gulp.src(['./build/scripts/stormplayer.js.map'])
        .pipe(gulp.dest('./dist/scripts'));
});
 ...
 * Copies sourcemaps generated by the TypeScript
 */
gulp.task('grabLibrary', function(){
    return gulp.src(['./node_modules/@stormstreaming/stormlibrary/dist/stormlibrary.min.js'])
        .pipe(gulp.dest('./dist/scripts'));
});
