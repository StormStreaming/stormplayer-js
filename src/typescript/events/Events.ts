...
import {MetaDataItem} from "@stormstreaming/stormlibrary/dist/types/model/MetaDataItem";
...
export interface StormPlayerEvent {
    ...
    "metadataReceived": {ref:StormPlayer, mode:string, metadata:MetaDataItem, streamKey:string}
